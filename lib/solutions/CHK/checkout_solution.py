...
def checkout(skus) -> int:
    ...
    if len(skus) > 1 and skus.isupper():
        ...
        for item in items:
            ...
            elif len(set(skus)) == 3 and len(skus) == 4 and item == "S" or item == "T" or item == "X" or item == "Y" or item == "Z"  and item_count == skus.count(
                    "T") >= 1 or item_count == skus.count(
                    "X") or item_count == skus.count("Y") >= 1 or item_count == skus.count(
                "Z") >= 1 or item_count == skus.count("S") >= 1:
                price = item_count * 15
